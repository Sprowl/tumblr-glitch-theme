...
/////////////////////////////
     ...
     * @param {_Canvas_} canvas An instance of the `Canvas` class, that can be used as an prepared image. The Glitch will use this image instead of one generated by html2canvas.
     */
